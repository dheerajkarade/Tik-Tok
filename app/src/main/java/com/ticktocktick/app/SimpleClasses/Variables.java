...
public class Variables {
    ...
    public static String gif_api_key1="BqVAJOS2soJ5TvwYm3ksYdrQ8ISp5aGE";

    public static final String privacy_policy="https://ticktocktick-fun.blogspot.com/2020/07/privacy-policy.html";


   
    public static final  String main_domain="https://ticktocktick.co/";
    public static final String base_url="https://ticktocktick.co/API/";
    public static final String api_domain ="https://ticktocktick.co/API/index.php?p=";
